  ...
  const features = [
    {
      ...
      description:
        "Spin up a game room in seconds and share a short link with friends.",
    },
    {
      title: "Private by default",
      description:
        "Lock lobbies with a password so only invited players can join.",
    },
    {
      title: "Built for teams",
      description:
        "Hand off leader role automatically and keep the room organized.",
    },
  ];
...
<section class="frontpage page">
  <div class="frontpage__hero">
    ...
    <h1 class="frontpage__title">
      Host, join, and manage your Christmas game lobbies.
    </h1>
    <p class="frontpage__subtitle">
      The Julekalender keeps your team together with easy lobby links, smooth
      handoffs, and quick starts.
    </p>
