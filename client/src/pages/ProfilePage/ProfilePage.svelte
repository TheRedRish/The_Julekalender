<script>
  ...
  async function handlePasswordReset() {
    ...
    try {
      ...
      setStatus("success", `A new password will be sent to ${$userStore.email}. Check your inbox.`);
    ...
    <div class="profile__card profile__card--main">
      <header class="profile__header">
        <div>
          ...
          <p class="profile__subtitle">Manage your account details and request a fresh password.</p>
        </div>
